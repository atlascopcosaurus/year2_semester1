...
// Fetch main books ordered by the latest date of publication
$main_books_query = "SELECT * FROM Producttb WHERE is_best_seller = FALSE AND is_featured = FALSE ORDER BY date_of_publication DESC LIMIT 8";
$main_books = $database->con->query($main_books_query);


// Fetch latest 3 bestseller books ordered by the latest date of publication
$bestseller_books_query = "SELECT * FROM Producttb WHERE is_best_seller = TRUE ORDER BY date_of_publication DESC LIMIT 3";
$bestseller_books = $database->con->query($bestseller_books_query);

// Fetch latest 4 featured books ordered by the latest date of publication
$featured_books_query = "SELECT * FROM Producttb WHERE is_featured = TRUE ORDER BY date_of_publication DESC LIMIT 3";
...
<section id="home" class="home-section slider">
    ...
    <div class="slider-wrapper">
        ...
        // Fetch the 3 latest featured books based on the date of publication
        $slider_books_query = "SELECT * FROM Producttb WHERE is_featured = TRUE ORDER BY date_of_publication DESC LIMIT 3";
...
<section id="projects">
    ...
    <div class="projects-grid">
        ...
        $books_query = "SELECT * FROM Producttb WHERE is_best_seller = FALSE AND is_featured = FALSE ORDER BY date_of_publication DESC LIMIT 8";
